...
export default function LoginForm(){
    ...
    <div className="w-full h-flex bg white flex flex-col justify-center items-center">
        <div className="text-center"> 
            ...
            <p className=" text-sm text-gray-500 font-normal mb-6">Faça login para acessar o sistema</p> 
        </div>
        <div className="shadow-xl bg-white p-10 rounded-2xl w-xl h-auto">
            <form className="flex flex-col justify-between h-full" onSubmit={handlesubmit}>
                <div className="space-y-7 flex flex-col justify-center items-center">
                    <div>
                        <label htmlFor="CPF" className="block w-md text-sm front-medium text-gray-700">
                            CPF
                        </label>
                        <input 
                        type="text"
                    ...
                    <div>
                        <label htmlFor="senha" className="block w-md text-sm font-medium text-gray-700">
                            Senha
                        </label>
                        <input 
                        type="password" 
